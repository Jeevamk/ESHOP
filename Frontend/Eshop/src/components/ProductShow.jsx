...
const ProductList = () => {
    const products = [
        ...
        { id: 4, name: 'Product 4', price: '$15.99', imageUrl: 'https://res.cloudinary.com/dsqsfves6/image/upload/v1716720775/Bluetooth-Speaker-PNG-Image-removebg-preview_zkns2d.png' },
    ...
    return (
        <div className="container mx-auto px-4 lg:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 ">
