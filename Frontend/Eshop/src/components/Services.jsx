...
const ServiceData = [
    ...
    {
        id: 2,
        icon: <FaCheckCircle className='text-4xl md:text-5xl text-blue-500' />,
        title: 'Safe Money',
        description: '30 Days Money Back Guarantee'
    },
    {
        id: 3,
        icon: <FaWallet className='text-4xl md:text-5xl text-blue-500' />,
        title: 'Secure Payment',
        description: 'All payments are secure'
    },
    {
        id: 4,
        icon: <FaHeadphonesAlt className='text-4xl md:text-5xl text-blue-500' />,
